                ...
                <div class="panel-footer">
                    <c:if test="${pagingVO != null}">
                        <nav style="text-align: center">
                            <ul class="pagination">
                                <li><a href="/admin/searchGrade?page=${pagingVO.upPageNo}&gradeid=${gradeIndex}">&laquo;上一页</a>
                                </li>
                                ...
                                <li><a href="/admin/searchGrade?page=${pagingVO.totalCount}&gradeid=${gradeIndex}">最后一页&raquo;</a>
                                </li>
                            </ul>
                        </nav>
                    </c:if>
