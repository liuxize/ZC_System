                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 align="center" class="modal-title">请输入科目名称</h4>
                                    </div>
                                    <form role="form" action="/admin/manageSubject" method="post">
                        ...
                        <tr>
                            ...
                            <th>
                                ...
                                <button type="button" class="btn btn-danger  btn-xs"
                                        onclick="deleteSubject('${item.subjectid}')">删除科目
                                </button>
...
<script type="text/javascript">
    ...
    function deleteSubject(subjectid) {
        var msg = "您确定要删除吗";
        if (confirm(msg) == true) {
            window.location.href="/admin/removeSubject?subjectid="+ subjectid;
            return true;
        } else {
            return false;
        }
