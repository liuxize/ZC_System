                    ...
                    <c:if test="${pagingVO != null}">
                        <nav style="text-align: center">
                            <ul class="pagination">
                                ...
                                <li><a href="/admin/paidNotStudent?page=${pagingVO.totalCount}&gradeid=${gradeIndex}&teleType=${teleType}">最后一页&raquo;</a></li>
                            </ul>
                        </nav>
                    </c:if>
                </div>
...
<script type="text/javascript">
    ...
    <%--var yearobj = document.getElementById("teletype");--%>
    <%--for(var i=0; i<yearobj.options.length; i++){--%>
        <%--//alert("ss");--%>
        <%--if(yearobj.options[i].value == ${teleType}){--%>
