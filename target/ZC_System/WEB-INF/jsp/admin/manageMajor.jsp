        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 align="center" class="modal-title">请输入专业名称</h4>
                                    </div>
                                    <form role="form" action="/admin/manageMajor" method="post">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                    <c:forEach items="${majorList}" var="item" varStatus="status">
                        <tr>
                            <th>${status.index + 1}</th>
                            <th>${item.majorname}</th>
                            <th>


                                <button type="button" class="btn btn-danger  btn-xs"
                                        onclick="deleteMajor('${item.majorid}')">删除专业
                                </button>
...
<script type="text/javascript">
    ...
    function deleteMajor(majorid) {
        var msg = "您确定要删除吗";
        if (confirm(msg) == true) {
            window.location.href="/admin/removeMajor?majorid="+ majorid;
            return true;
        } else {
            return false;
        }
