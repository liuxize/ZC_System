...
<div class="container" id="content">
    <div class="row">
        ...
        <div class="col-md-12 container" >
            ...
            <form role="form" action="/master/addTableOne" id="editstu" method="post">
                ...
                <table class="table table-bordered text-center table-striped ">
                    ...
                    <tr>
                        ...
                        <td>检验日期</td>
                        <td colspan="3">
                            <input class="inp4"  max="9999-12-31" type="date" style="width: 300px" name="checkdate"/>
                        </td>
                    </tr>
                    <tr>
