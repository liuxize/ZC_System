                ...
                <span style="float:right;">
                   制表时间：&nbsp;
                    ...
                    制表人:&nbsp; ${stumessage.recordperson}
                     &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                     负责人签字:&nbsp;
                    <C:if test="${signmessage.leadersignid==0}"><font color="red">${signmessage.leadersign}</font></C:if>
                    <C:if test="${signmessage.leadersignid==1}">${signmessage.leadersign}</C:if>
                     &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    校长签字:&nbsp;
                    <C:if test="${signmessage.mastersignid==0}"><font color="red">${signmessage.mastersign}</font></C:if>
...
<%--                                    <form role="form" action="/master/addName" method="post">--%>
<%--                                        <div class="modal-header">--%>
<%--                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">--%>
<%--                                                &times;--%>
<%--                                            </button>--%>
...
<%--                        <!-- 模态框（Modal）添加学校历史 结束-->--%>
                        ...
                        <div class="modal fade" id="addSchoolModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addSchool" id="editstu" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                    ...
                    <div class="modal fade" id="addStuSexModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog"> <!-- modal-lg 放大版-->
                            <div class="modal-content">
                                ...
                                <form role="form" action="/master/addStuSex" method="post">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                            &times;
                                        </button>
                        ...
                        <div class="modal fade" id="addMotherModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addMother"  method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                                        ...
                                        <div class="modal-body">
                                            <input type="text" class="form-control" name="motherName" required="required"
                                                   placeholder="请输入">
                                            <input type="hidden" name="stuid" value=${stumessage.stuid}>
                                        </div>
                                        <div class="modal-footer">
                        ...
                        <div class="modal fade" id="addMoCompanyModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addMoCompany" id="editMocom" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                                        ...
                                        <div class="modal-body">
                                            <input type="text" class="form-control" id="addMocompany" required="required"
                                                   name="motherCompany"
                                                   placeholder="请输入">
                                            <input type="hidden" name="stuid" value=${stumessage.stuid}>
                                        </div>
                    ...
                    <div class="modal fade" id="addMoDegreeModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog"> <!-- modal-lg 放大版-->
                            <div class="modal-content">
                                ...
                                <form role="form" action="/master/addMotherGegree"  method="post">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                            &times;
                                        </button>
                        ...
                        <div class="modal fade" id="addMoJobModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addMoJob" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                                        ...
                                        <div class="modal-body">
                                            <input type="text" class="form-control" name="motherJob" required="required"
                                                   placeholder="请输入">
                                            <input type="hidden" name="stuid" value=${stumessage.stuid}>
                                        </div>
                                        <div class="modal-footer">
                        ...
                        <div class="modal fade" id="addFatherModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addFather"  method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addFaComModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addFaCompany" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                                        ...
                                        <div class="modal-body">
                                            <input type="text" class="form-control" name="fathercompany" required="required"
                                                   placeholder="请输入">
                                            <input type="hidden" name="stuid" value=${stumessage.stuid}>
                                        </div>
                                        <div class="modal-footer">
                    ...
                    <div class="modal fade" id="addFaDegreeModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog"> <!-- modal-lg 放大版-->
                            <div class="modal-content">
                                ...
                                <form role="form" action="/master/addFatherGegree"  method="post">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                            &times;
                                        </button>
                        ...
                        <div class="modal fade" id="addFaJobModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addFaJob" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addteacherModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addMaster" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addMasterAddressModel" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addMasterAddress" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addMasterDegreeModel" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addMasterDegree" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addMasterSexModel" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addMasterSex" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addAddressModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addAddress" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                                        ...
                                        <div class="modal-body">
                                            <input type="text" class="form-control" name="addAddress" required="required"
                                                   placeholder="请输入">
                                            <input type="hidden" name="stuid" value=${stumessage.stuid}>
                                        </div>
                                        <div class="modal-footer">
                        ...
                        <div class="modal fade" id="addBirthModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addBirth" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addMoBirthModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addMoBirth" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addFaBirthModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addFaBirth" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addMasterBirthModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addMasterBirth" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addStuTelModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addStuTel" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addMotherTelModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addMotherTel" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addFatherTelModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addFatherTel" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addMasterTelModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addMasterTel" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addMajorModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addMajor" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addCheckDateModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addCheckDate" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addSchoolText" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addSchoolText" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                                        ...
                                        <div class="modal-body">
                                            <textarea class="form-control" rows="6" name="addschooltext" required="required"
                        ...
                        <div class="modal fade" id="addFamilyText" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addFamilyText" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                                        ...
                                        <div class="modal-body">
                                            <textarea class="form-control" rows="6" name="addfamilytext" required="required"
                                                      placeholder="请输入" style="resize: none;"></textarea>
                                            <input type="hidden" name="stuid" value=${stumessage.stuid}>
                                        </div>
                                        <div class="modal-footer">
                        ...
                        <div class="modal fade" id="addStudyText" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addStudyText" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                                        ...
                                        <div class="modal-body">
                                            <textarea class="form-control" rows="6" name="addstudytext" required="required"
                                                      placeholder="请输入" style="resize: none;"></textarea>
                                            <input type="hidden" name="stuid" value=${stumessage.stuid}>
                                        </div>
                                        <div class="modal-footer">
                ...
                <tr>
                    <td colspan="3">
                        <C:if test="${signmessage.educationtextsign==0}"><font color="red">众成结合以上三个方面，<br>针对学生给予的教育方案</font></C:if>
                        ...
                        <div class="modal fade" id="addEduText" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addEducationText" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                                        ...
                                        <div class="modal-body">
                                            <textarea class="form-control" rows="6" name="addedutext" required="required"
                                                      placeholder="请输入" style="resize: none;"></textarea>
                                            <input type="hidden" name="stuid" value=${stumessage.stuid}>
                                        </div>
                                        <div class="modal-footer">
                        ...
                        <div class="modal fade" id="addSupportText" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addSupportText" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                                        ...
                                        <div class="modal-body">
                                            <textarea class="form-control" rows="6" name="addsupporttext" required="required"
                                                      placeholder="请输入" style="resize: none;"></textarea>
                                            <input type="hidden" name="stuid" value=${stumessage.stuid}>
                                        </div>
                                        <div class="modal-footer">
                        ...
                        <div class="modal fade" id="addImproveText" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/master/addImproveText" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                                        ...
                                        <div class="modal-body">
                                            <textarea class="form-control" rows="6" name="addimprovetext" required="required"
                                                      placeholder="请输入" style="resize: none;"></textarea>
                                            <input type="hidden" name="stuid" value=${stumessage.stuid}>
                                        </div>
                                        <div class="modal-footer">
...
<script type="text/javascript">
    ...
    function ToTableOne(str) {
        var a=btoa(str);
        window.location.href="/master/editTableOne?encodeID="+a;
    }

    function ToTableTwo(str) {
        var a=btoa(str);
        window.location.href="/master/editTableTwo?encodeID="+a;
    }

    function ToTableThree(str) {
        var a=btoa(str);
        window.location.href="/master/editTableThree?encodeID="+a;
    }
</script>
</html>
