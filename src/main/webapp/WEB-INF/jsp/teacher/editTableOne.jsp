                        ...
                        <div class="modal fade" id="addStuNameModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addName" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                    ...
                    <div class="modal fade" id="addStuSexModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog"> <!-- modal-lg 放大版-->
                            <div class="modal-content">
                                ...
                                <form role="form" action="/teacher/addStuSex" method="post">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                            &times;
                                        </button>
                        ...
                        <div class="modal fade" id="addMotherModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addMother" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addMoCompanyModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addMoCompany" id="editMocom" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                    ...
                    <div class="modal fade" id="addMoDegreeModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog"> <!-- modal-lg 放大版-->
                            <div class="modal-content">
                                ...
                                <form role="form" action="/teacher/addMotherGegree" method="post">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                            &times;
                                        </button>
                        ...
                        <div class="modal fade" id="addMoJobModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addMoJob" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addFatherModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addFather" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addFaComModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addFaCompany" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                    ...
                    <div class="modal fade" id="addFaDegreeModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog"> <!-- modal-lg 放大版-->
                            <div class="modal-content">
                                ...
                                <form role="form" action="/teacher/addFatherGegree" method="post">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                            &times;
                                        </button>
                        ...
                        <div class="modal fade" id="addFaJobModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addFaJob" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addteacherModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addMaster" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addMasterAddressModel" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addMasterAddress" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addMasterDegreeModel" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addMasterDegree" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addMasterSexModel" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addMasterSex" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addAddressModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addAddress" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addBirthModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addBirth" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addMoBirthModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addMoBirth" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addFaBirthModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addFaBirth" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addMasterBirthModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addMasterBirth" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addStuTelModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addStuTel" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addMotherTelModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addMotherTel" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addFatherTelModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addFatherTel" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addMasterTelModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addMasterTel" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addMajorModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addMajor" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addCheckDateModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addCheckDate" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addSchoolText" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addSchoolText" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addFamilyText" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addFamilyText" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addStudyText" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addStudyText" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addEduText" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addEducationText" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addSupportText" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addSupportText" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addImproveText" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/teacher/addImproveText" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
