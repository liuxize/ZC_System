...
<div class="container" id="content">
    <div class="row">
        ...
        <div class="col-md-15 container" >
            ...
            <form role="form" action="/admin/addTableOne" id="editstu" method="post">
                ...
                <table class="table table-bordered text-center table-striped ">
                    ...
                    <tr>
                        ...
                        <td class="text-left" colspan="10">
                            学生：
                            <input size="10" class="inp4" type="date"  max="9999-12-31"  style="width: 180px;"  max="9999-12-31"  name="stubirth"/>
                            <%--<input class="inp4" type="text" name="stutel" placeholder="请输入"/>--%>
                            &nbsp; &nbsp;&nbsp;
                            母亲：
                            <input class="inp4" type="date" style="width: 180px"  max="9999-12-31" name="motherbirth"/>
                            &nbsp; &nbsp;&nbsp;
                            父亲：
                            <input class="inp4" type="date" style="width: 180px"  max="9999-12-31" name="fatherbirth"/>
                            &nbsp; &nbsp;&nbsp;
                            班主任：
                            <input class="inp4" type="date" style="width: 180px"  max="9999-12-31" name="masterbirth"/>
                        </td>
                    </tr>
