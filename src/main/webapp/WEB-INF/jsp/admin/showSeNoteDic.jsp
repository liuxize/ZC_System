                        ...
                        <tr>
                            ...
                            <th>
                                <button type="button" class="btn btn-primary btn-xs"
                                        onClick="window.open('/admin/editSeNoteTable?dicid=${item.dicid}')">查看表格
                                </button>
                    ...
                    <c:if test="${pagingVO != null}">
                        <nav style="text-align: center">
                            <ul class="pagination">
                                ...
                                <li><a href="/admin/showSeNoteDic?page=${pagingVO.totalCount}">最后一页&raquo;</a></li>
                            </ul>
                        </nav>
                    </c:if>
                </div>
...
<script type="text/javascript">
    ...
    function remove(dicid,page) {
        var msg = "您确定要删除吗";
        if (confirm(msg) == true) {
            window.location.href="/admin/removeSeNoteDic?dicid=" + dicid + "&currentPage=" +page;
            return true;
        } else {
            return false;
        }
