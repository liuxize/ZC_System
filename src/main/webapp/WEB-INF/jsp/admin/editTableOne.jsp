                        ...
                        <div class="modal fade" id="addStuNameModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/admin/addName" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addSchoolModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/admin/addSchool" id="editstu" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                    ...
                    <div class="modal fade" id="addStuSexModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog"> <!-- modal-lg 放大版-->
                            <div class="modal-content">
                                ...
                                <form role="form" action="/admin/addStuSex" method="post">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                            &times;
                                        </button>
                        ...
                        <div class="modal fade" id="addMotherModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/admin/addMother" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addMoCompanyModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/admin/addMoCompany" id="editMocom" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                    ...
                    <div class="modal fade" id="addMoDegreeModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog"> <!-- modal-lg 放大版-->
                            <div class="modal-content">
                                ...
                                <form role="form" action="/admin/addMotherGegree" method="post">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                            &times;
                                        </button>
                        ...
                        <div class="modal fade" id="addMoJobModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/admin/addMoJob" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addFatherModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/admin/addFather" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addFaComModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/admin/addFaCompany" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                    ...
                    <div class="modal fade" id="addFaDegreeModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog"> <!-- modal-lg 放大版-->
                            <div class="modal-content">
                                ...
                                <form role="form" action="/admin/addFatherGegree" method="post">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                            &times;
                                        </button>
                        ...
                        <div class="modal fade" id="addFaJobModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/admin/addFaJob" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addteacherModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/admin/addMaster" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addMasterAddressModel" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/admin/addMasterAddress" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addMasterDegreeModel" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/admin/addMasterDegree" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addMasterSexModel" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/admin/addMasterSex" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addAddressModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/admin/addAddress" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                    ...
                    <div class="modal fade" id="addBirthModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog"> <!-- modal-lg 放大版-->
                            <div class="modal-content">
                                ...
                                <form role="form" action="/admin/addBirth" method="post">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                            &times;
                                        </button>
                    ...
                    <div class="modal fade" id="addMoBirthModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog"> <!-- modal-lg 放大版-->
                            <div class="modal-content">
                                ...
                                <form role="form" action="/admin/addMoBirth" method="post">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                            &times;
                                        </button>
                    ...
                    <div class="modal fade" id="addFaBirthModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog"> <!-- modal-lg 放大版-->
                            <div class="modal-content">
                                ...
                                <form role="form" action="/admin/addFaBirth" method="post">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                            &times;
                                        </button>
                    ...
                    <div class="modal fade" id="addMasterBirthModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog"> <!-- modal-lg 放大版-->
                            <div class="modal-content">
                                ...
                                <form role="form" action="/admin/addMasterBirth" method="post">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                            &times;
                                        </button>
                        ...
                        <div class="modal fade" id="addStuTelModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/admin/addStuTel" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addMotherTelModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/admin/addMotherTel" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addFatherTelModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/admin/addFatherTel" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addMasterTelModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/admin/addMasterTel" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addMajorModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/admin/addMajor" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addCheckDateModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/admin/addCheckDate" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addSchoolText" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/admin/addSchoolText" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addFamilyText" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/admin/addFamilyText" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addStudyText" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/admin/addStudyText" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addEduText" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/admin/addEducationText" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addSupportText" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/admin/addSupportText" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
                        ...
                        <div class="modal fade" id="addImproveText" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    ...
                                    <form role="form" action="/admin/addImproveText" method="post">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                                &times;
                                            </button>
