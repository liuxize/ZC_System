                            ...
                            <div class="modal-dialog"> <!-- modal-lg 放大版-->
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 align="center" class="modal-title">请输入年级名称</h4>
                                    </div>
                                    <form role="form" action="/admin/manageGrade" method="post">
                ...
                <table class="table table-bordered">
                    ...
                    <c:forEach items="${gradeList}" var="item" varStatus="status">
                        <tr>
                            ...
                            <th>${item.gradename}</th>
                            <th>
                                <c:choose>
                                    <c:when test="${item.gradeid <=18}">
                                        <button type="button" disabled="disabled" class="btn btn-danger  btn-xs"
                                                onclick="deleteGrade('${item.gradeid}')">删除年级名称
                                        </button>
                                    </c:when>
...
<script type="text/javascript">
    ...
    function deleteGrade(gradeid) {
        var msg = "您确定要删除吗";
        if (confirm(msg) == true) {
            window.location.href="/admin/removeGrade?gradeid="+ gradeid;
            return true;
        } else {
            return false;
        }
